...
export declare const DEFAULT_FLOW_MANAGER_OPTIONS: TFlowManagerOptions;
...
export type TFlowDispatchMethodOutput = TFlowBaseActionMethodOutput & Pick<TStepOptions, 'clearHistory' | 'ignoreHistory'>;
